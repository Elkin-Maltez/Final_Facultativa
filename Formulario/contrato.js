...
class Contrato extends Component{
    constructor(){
        ...
        this.state = {
            ...
            apellido: '',
            direccion:'',
            tableHead: ['Cedula', 'Nombres', 'Apellidos', 'Dirección'],
            tableData: [
    ...
    onSubmit = () =>{
        var data = [this.state.cedula,this.state.nombre,this.state.apellido,this.state.direccion]
        var tabla = this.state.tableData
        ...
        return(
            <View style= {styles.container}>
                <View style= {styles.listado}>
                    <Text style={styles.title}>Registro de nuevos clientes</Text>
                    <TextInput
                        style={styles.input}
